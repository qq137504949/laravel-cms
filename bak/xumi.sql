...
-- ----------------------------
BEGIN;
INSERT INTO `xm_admin` VALUES ('1', 'root', '137504949@qq.com', '$2y$10$Lxf7aWAPtAruUTBS.7VBP.CRjobfsngn7gb3MoO7zJn8CjOt/6c2u', 'F8oYCzOiJgamM1VNW8GgJTQqbK9lHbSfhT8pqJIwDfmTfXhE3TnOXrZAv3rP', '2017-09-25 08:04:57', '2017-09-28 05:03:33', null, '0', '1', '0');
COMMIT;

-- ----------------------------
--  Table structure for `xm_admin_log`
-- ----------------------------
DROP TABLE IF EXISTS `xm_admin_log`;
...
-- ----------------------------
--  Records of `xm_admin_menus`
-- ----------------------------
BEGIN;
INSERT INTO `xm_admin_menus` VALUES ('1', '系统管理', 'fa-bar-chart-o', '', '0'), ('2', '角色管理', null, 'admin/role', '1'), ('3', '用户管理', null, 'admin/user', '1'), ('4', '菜单管理', '', 'admin/menu', '1'), ('5', '管理员日志', null, 'admin/admin-log', '1'), ('26', '站点设置', null, 'admin/system', '1');
COMMIT;

-- ----------------------------
--  Table structure for `xm_gadmin`
-- ----------------------------
DROP TABLE IF EXISTS `xm_gadmin`;
CREATE TABLE `xm_gadmin` (
...
-- ----------------------------
--  Records of `xm_gadmin`
-- ----------------------------
BEGIN;
INSERT INTO `xm_gadmin` VALUES ('1', '后台管理员', '1,2,3,4,5,17,18,19,20,23,25,21,22,24'), ('2', '供应商', '17,18,19'), ('3', '出入库管理者', '17,20,23');
COMMIT;
...
-- ----------------------------
BEGIN;
INSERT INTO `xm_system` VALUES ('1', '郑州-100344334', null, '郑州赢鸿', '郑州二手房_郑州二手房出售_郑州二手房网(郑州赢鸿网)', 0xe98391e5b79ee4ba8ce6898be688bf5fe98391e5b79ee4ba8ce6898be688bfe587bae594ae5fe98391e5b79ee4ba8ce6898be688bfe7bd9128e98391e5b79ee8b5a2e9b8bfe7bd9129, 'xumi.net', '0371-60166618', '郑州市郑东新区地润路5-3号', '873366181@qq.com', null, '18037698368');
COMMIT;
